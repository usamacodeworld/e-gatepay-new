...
use App\Mail\NewMerchantRegisteredMail;
...
class RegisteredUserController extends Controller
{
    ...
    {
        return view('frontend.auth.merchant.register');
    }
    ...
    {
        // 1. Validate request with merchant specific fields
        ...
        // 4. Create user (always as merchant)
        $user = User::create([
        ...
        Mail::to('sales@e-gatepay.net')->send(new NewMerchantRegisteredMail($user));
        ...
        return redirect()->route('merchant.login')->with('success', __('Our Team Will Contact your within 24 hours.'));
    }
}
